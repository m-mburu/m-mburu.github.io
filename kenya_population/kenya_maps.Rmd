...
tm_shape(kenya_births_counties)+
  ...
  tm_layout(title = "", main.title = "Percentage of health facility births in Kenya")
ttm()
```
...
```{r}
ttm()
tm_shape(pop_crops_counties_not_maize)+
  tm_borders(col = "gold")+
  tm_fill(col = "crops")+
  #tm_bubbles(size = "Perc", col = "gold")+
  tm_layout(main.title = "Popular crop grown per county Kenya apart from maize")
ttm()
```
...
```{r}
ttm()
tm_shape(pop_crops_counties_not_mbp)+
  tm_borders(col = "gold")+
  tm_fill(col = "crops")+
  #tm_bubbles(size = "Perc", col = "gold")+

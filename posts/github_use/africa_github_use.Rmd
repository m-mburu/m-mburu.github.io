...
author: "Mburu"
date: "2026-02-22"
description: "A map-based look at GitHub activity across Africa and what public developer data can and cannot tell us."
...
# Fix PROJ database mismatch (common when R runs inside Conda)
# This prevents sf/ggplot2 CRS-related errors during rendering.
...
```{r process_df-to-sf, fig.width=4, fig.height=4}
...
github_pushes_map <- create_interactive_map(
    data_sf = git_pushes_sf,
    fill_var = devs_per_100k,
    tooltip_var = name,

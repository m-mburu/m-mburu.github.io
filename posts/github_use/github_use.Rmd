...
I have done an analysis of [GitHub Innovation Graph data](https://github.com/github/innovationgraph/tree/main) for Africa and this is the same analysis for the world. It's a good thind to see where we are compared to the rest of the world.
